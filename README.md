...
| [`dev/sqldatabases`](/dev/sqldatabases.bicep) | A lightweight container running the `mssql` image for development purposes. | `radius.azurecr.io/recipes/dev/sqldatabases:TAG` |
